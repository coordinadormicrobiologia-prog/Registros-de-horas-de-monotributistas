        ...
        <div className="p-6 border-b flex justify-between items-center">
          <div>
            <h3 className="text-lg font-bold text-slate-800">
              {showAll ? 'Todos tus Registros' : 'Tus Registros Recientes'}
            </h3>
              ...
              <tbody className="divide-y">
                {allMyLogs.map(log => (
                  <tr key={log.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm font-semibold text-slate-700">{log.totalHours}h</td>
                    <td className="px-4 py-3 text-sm text-slate-600">{log.dayType}</td>
